"""
gan_generate_co2.py — PyTorch CGAN for Carbon Dioxide (CO2)
...
Performs TWO separate CGAN balancing passes:
  ...
  Pass 2: Balance 'over_tlv' (0,1) -> N_max = 21,960
          Class 1: 21,960 samples (majority)
          Class 0: 8,040 samples -> synthesize 13,920 CGAN samples

Output: gas_sensors/data/mine_part2_co2_balanced_cgan.csv
"""
import os
import pandas as pd
import numpy as np
...
def run():
    print("=" * 60)
    print("PYTORCH CGAN: CO2 — severity + over_tlv BALANCING")
    print("=" * 60)
    ...
    for i, orig_cls in inv_map.items():
        ...
        if needed > 0:
            ...
            # Severity mapping for CO2: L1=0 (below 0.03% TLV), L2=1, L3=2
