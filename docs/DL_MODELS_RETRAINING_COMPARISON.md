...
| `ch4_severity` | `severity` | Methane | **LayerNormSwishMLP** | **99.71%** | **0.9971** | **1.0000** | `gas_sensors/models/ch4_severity_dl_best.joblib` |
...
| `co2_severity` | `severity` | Carbon | **LayerNormSwishMLP** | **95.01%** | **0.9490** | **0.9954** | `gas_sensors/models/co2_severity_dl_best.joblib` |
...
|---|---|---|---|---|---|:---:|
| `part1_warmup_dl_best.joblib` | **LayerNormSwishMLP** | **100.00%** | **100.00%** | `mine_part1_balanced_gan.csv` (122,025 rows) | `mine_part1_balanced_gan.csv` (40,675 rows) | 75:25 (0.75 / 0.25) |
| `ch4_severity_dl_best.joblib` | **LayerNormSwishMLP** | **99.68%** | **99.71%** | `mine_part2_ch4_balanced_cgan.csv` (45,000 rows) | `mine_part2_ch4_balanced_cgan.csv` (15,000 rows) | 75:25 (0.75 / 0.25) |
...
| `co2_severity_dl_best.joblib` | **LayerNormSwishMLP** | **94.90%** | **95.01%** | `mine_part2_co2_balanced_cgan.csv` (45,000 rows) | `mine_part2_co2_balanced_cgan.csv` (15,000 rows) | 75:25 (0.75 / 0.25) |
...
| **Rank 2** | **WideAndDeepNet** | 100.00% | 1.0000 | 1.0000 | 1.0000 | 1.0000 | Discarded |
...
| Rank | Architecture Candidate | Test Accuracy | Precision | Recall | Macro F1-Score | ROC-AUC | Status |
|:---:|---|---|---|---|---|---|---|
| **Rank 1** | **LayerNormSwishMLP** | 99.71% | 0.9971 | 0.9971 | 0.9971 | 1.0000 | **SAVED (WINNER)** |
| **Rank 2** | **SelfAttentionMLP** | 99.65% | 0.9965 | 0.9965 | 0.9965 | 1.0000 | Discarded |
| **Rank 3** | **ResNet1DMLP** | 99.39% | 0.9939 | 0.9939 | 0.9939 | 1.0000 | Discarded |
...
| **Rank 2** | **SelfAttentionMLP** | 97.48% | 0.9766 | 0.9748 | 0.9748 | 0.9982 | Discarded |
| **Rank 3** | **ResNet1DMLP** | 92.63% | 0.9396 | 0.9263 | 0.9254 | 0.9924 | Discarded |
...
| Rank | Architecture Candidate | Test Accuracy | Precision | Recall | Macro F1-Score | ROC-AUC | Status |
|:---:|---|---|---|---|---|---|---|
| **Rank 1** | **LayerNormSwishMLP** | 95.01% | 0.9536 | 0.9501 | 0.9490 | 0.9954 | **SAVED (WINNER)** |
| **Rank 2** | **SelfAttentionMLP** | 94.98% | 0.9533 | 0.9498 | 0.9487 | 0.9953 | Discarded |
| **Rank 3** | **WideAndDeepNet** | 94.86% | 0.9523 | 0.9486 | 0.9474 | 0.9944 | Discarded |
...
| Rank | Architecture Candidate | Test Accuracy | Precision | Recall | Macro F1-Score | ROC-AUC | Status |
|:---:|---|---|---|---|---|---|---|
| **Rank 1** | **LayerNormSwishMLP** | 99.97% | 0.9997 | 1.0000 | 0.9998 | 1.0000 | **SAVED (WINNER)** |
| **Rank 2** | **SelfAttentionMLP** | 99.94% | 0.9992 | 1.0000 | 0.9996 | 1.0000 | Discarded |
| **Rank 3** | **ResNet1DMLP** | 99.20% | 0.9899 | 1.0000 | 0.9949 | 1.0000 | Discarded |
...
| **Rank 3** | **ResNet1DMLP** | 97.24% | 0.9745 | 0.9724 | 0.9727 | 0.9988 | Discarded |
...
| **Rank 3** | **Conv1DNet** | 99.52% | 0.9916 | 1.0000 | 0.9958 | 1.0000 | Discarded |
